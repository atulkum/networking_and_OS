...
Yield:
	...
	.ent	CGetInLine
CGetInLine:
	addiu $2,$0,SC_CGetInLine
	syscall
	j	$31
	.end CGetInLine

	.globl CWaitForHelper
	.ent	CWaitForHelper
CWaitForHelper:
	addiu $2,$0,SC_CWaitForHelper
	syscall
	j	$31
	.end CWaitForHelper

	.globl CWaitForUnload
	.ent	CWaitForUnload
CWaitForUnload:
	addiu $2,$0,SC_CWaitForUnload
	syscall
	j	$31
	.end CWaitForUnload
